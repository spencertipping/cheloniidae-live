...
//   position, direction, etc. all at a moment; you get a new turtle after a line is drawn.
  ...
  d.init (String.prototype, {patching_constructor: '("new @constructor (d.init ({" + @toString() + ": $0}), $_)").fn()'.fn()});
  ...
  var rotational_turtle = '$0($_, $1)'.fn(d.init).ctor ({line: '@queue.push(new line(@position.clone(), @position.clone().add_scaled (@direction, $0), @pen)), $_'.fn(),
                                                         ...
                                                         jump: 'new @constructor(d.init({position:   @position.clone().add_scaled (@direction, $0)}, $_))'.fn(),
                                                         turn: 'new @constructor(d.init({direction:  @direction.about (@complement, $0)}, $_))'.fn(),
                                                         bank: 'new @constructor(d.init({complement: @complement.about (@direction, $0)}, $_))'.fn(),
                                                          pen: 'new @constructor(d.init({pen:        $0}))'.fn(),
